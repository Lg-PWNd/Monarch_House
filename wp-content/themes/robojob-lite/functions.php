...
if ( ! function_exists('robojob_lite_register_required_plugins') ) {
	function robojob_lite_register_required_plugins() {
		...
		$plugins = array(
			...
			array(
				'name'      => 'WP Job Manager - Job Type Colors ',
...
if (! function_exists('robojob_lite_add_menu_users')) {
	...
	function robojob_lite_add_menu_users( $items, $args ) {
			...
			$useremail = $current_user->user_email;
		  	if (is_user_logged_in() && $args->theme_location == 'primary' ) {
			  	if ( current_user_can('administrator') || current_user_can('employer') ) {
			       ...
			       $items .= '<li class="menu-item"><a href="'.   esc_url( home_url( '/' )) .'job-dashboard">'.__('Manage Jobs', 'robojob-lite').'</a></li>';
			   	   $items .= '<li class="menu-item"><a href="'.   esc_url( home_url( '/' )) .'job-dashboard">'.__('Dashboard', 'robojob-lite').'</a></li>';
			       $items .= '<li class="menu-item"><a href="'.   esc_url( home_url( '/' ) ) .'wp-admin/profile.php">'.__('Edit Profile', 'robojob-lite').'</a></li>';
		    ...
		    elseif ( ! is_user_logged_in() && $args->theme_location == 'primary' ) {
		       ...
		       $items .= '<li class="login-menu"><a href="'. wp_login_url( home_url() ).'" title="Login">'.__('Log In', 'robojob-lite').'</a></li>';
