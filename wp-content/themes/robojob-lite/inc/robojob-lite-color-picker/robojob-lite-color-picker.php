 ...
 */
class Customize_Opacity_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'robojob-pro-color-picker',
			get_template_directory_uri() . '/inc/robojob-pro-color-picker/robojob-pro-color-picker.js',
		...
		wp_enqueue_style(
			'robojob-pro-color-picker',
			get_template_directory_uri() . '/inc/robojob-pro-color-picker/robojob-pro-color-picker.css',
