...
if (! function_exists('robojob_lite_scripts')) {
  function robojob_lite_scripts() {
          ...
          wp_localize_script( 'robojob-lite-app-js', 'global_url', array(
          ...
          $banner_text_color = $robojob_lite_theme_options['banner_text_color'];
          $logo_height = $robojob_lite_theme_options['logo_height'];
        ...
        if ( is_plugin_inactive( 'wp-job-manager-colors/wp-job-manager-colors.php' ) ) {
            /*
            ==============================
                  WPJob Manager
            ===============================*/
...
if (! function_exists('robojob_lite_styles_dequeue')) {
  // Dequeue Styles
  add_action('wp_print_styles', 'robojob_lite_styles_dequeue', 200);
  function robojob_lite_styles_dequeue() {
    wp_dequeue_style( 'wp-job-manager-frontend' );
    wp_dequeue_style( 'wp-job-manager-resume-frontend' );
  }
}

if (! function_exists('robojob_lite_admin_style')) {
  // Custom Admin Styles
  function robojob_lite_admin_style() {
          wp_enqueue_style('robojob-admin-styles', get_stylesheet_directory_uri().'/assets/css/admin/admin.min.css');
  }
  add_action('admin_enqueue_scripts', 'robojob_lite_admin_style');
}
