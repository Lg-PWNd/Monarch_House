...
if ( ! function_exists('robojob_lite_get_post_views') ) {
    function robojob_lite_get_post_views( $postID ) {
...
if ( ! function_exists('robojob_lite_set_post_views') ) {
    function robojob_lite_set_post_views( $postID ) {
...
if ( is_plugin_active('wp-job-manager-companies/wp-job-manager-companies.php') ) {
...
if ( ! function_exists('robojob_lite_mime_types') ) {
    function robojob_lite_mime_types( $mimes ) {
      $mimes['svg'] = 'image/svg+xml';
      $mimes['mp3'] = 'audio/mpeg';
      $mimes['mp4'] = 'video/mp4';
      return $mimes;
    }
    add_filter('upload_mimes', 'robojob_lite_mime_types');
}
        ...
        if ($version_wp < 4.5 ) {
                ...
                <?php }
                    ...
                    elseif ( function_exists('the_custom_logo') && ! empty($robojob_lite_theme_options['logo_img']) ) {
                        $previous_logo = wpcom_vip_attachment_url_to_postid($robojob_lite_theme_options['logo_img']);
...
if (! function_exists('robojob_lite_wp_mail_from_name')) {

    add_filter( 'wp_mail_from_name', 'robojob_lite_wp_mail_from_name' );
    function robojob_lite_wp_mail_from_name( $original_email_from ) {
...
if ( ! function_exists( 'robojob_lite_login_redirect' ) ) {

    // Redirect on login
    function robojob_lite_login_redirect( $url, $request, $user ){

        if( $user && is_object( $user ) && is_a( $user, 'WP_User' ) ) {
            if( $user->has_cap( 'administrator' ) ) {
                $url = home_url();
            }
            else if ($user->has_cap( 'employer' )){
    ...
    add_filter('login_redirect', 'robojob_lite_login_redirect', 10, 3 );
}



if ( ! function_exists( 'robojob_lite_archive_link' ) ) {
    function robojob_lite_archive_link( $post ){
