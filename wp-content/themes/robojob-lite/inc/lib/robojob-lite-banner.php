		                                		...
		                                		if ( is_plugin_active('wp-job-manager/wp-job-manager.php') ) { ?>
				                                    ...
				                                    <div class="c2a-btn">
														...
														<?php if ( !empty($find_a_job_link) ) { ?>
				                                          <a type="button" class="btn btn-default btn-lg" href="<?php echo esc_url( home_url( '/' ) ); ?><?php echo esc_attr($find_a_job_link);?>"><?php echo esc_html_e('Find a job', 'robojob-lite'); ?></a>
														<?php } if ( !empty($find_a_job_link) && !empty($post_a_job_link) ) {?>
				                                          <span class="btn-circle btn-or"><?php echo esc_html_e('or', 'robojob-lite'); ?></span>
														<?php } if ( !empty($post_a_job_link) ) {?>
				                                          <a type="button" class="btn btn-primary btn-lg" href="<?php echo esc_url( home_url( '/' ) ); ?><?php echo esc_attr($post_a_job_link);?>/"><?php echo esc_html_e('Post a job', 'robojob-lite'); ?></a>
														<?php } ?>
				                                        </div>
				                                    </div>
