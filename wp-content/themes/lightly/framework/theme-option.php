...
if (!function_exists('inwave_of_options')) {
    function inwave_of_options()
    {
        ...
        $inwave_of_options[] = array("name" => esc_html__("Develop mode", 'injob'),
            "desc" => esc_html__("Check this box to active develop theme mode. For example, it will always complile the color file", 'injob'),
            "id" => "develop_mode",
            "std" => 0,
            "type" => "checkbox");
        $inwave_of_options[] = array(
        ...
        $inwave_of_options[] = array("name" => esc_html__("Breadcrumbs Link Hover Color", 'injob'),
            "desc" => esc_html__("Controls the link hover color of the breadcrumb.", 'injob'),
        ...
        $inwave_of_options[] = array("name" => esc_html__("Background Color Header", 'injob'),
            "desc" => esc_html__("Only used for header version 3, 4 .", 'injob'),
            "id" => "bg_header_color",
            "std" => "#34495E",
            "type" => "color");
        ...
        $inwave_of_options[] = array("name" => esc_html__("Page Heading Background Color", 'injob'),
            "desc" => esc_html__("Please choose an color to use for the page title background.", 'injob'),
            "id" => "page_title_bg_color",
            "std" => "#34495E",
            "type" => "color");
