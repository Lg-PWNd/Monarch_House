...
$show_find_jobs = function_exists('iwj_option') ? iwj_option('show_find_jobs') : false;
...
<?php if (($show_page_heading && $show_page_heading != 'no')) { ?>
    <?php if ($show_find_jobs && (is_tax(get_object_taxonomies( 'iwj_job' )) || is_page(iwj_get_page_id('jobs')))) { ?>
        <div class="page-heading jobs">
            <div class="container-inner">
                <div class="container">
                    <?php if (!$search_form_jobs_style) {
                    ...
                    if ($search_form_jobs_style == 'style1') {
                        echo do_shortcode('[iwj_advanced_search]');
                    }
                    elseif ($search_form_jobs_style == 'style2') {
                        echo do_shortcode('[iwj_advanced_search_with_radius]');
                    }
                    else {
                        echo do_shortcode('[iwj_find_jobs]');
                    }
                    ?>
                </div>
            </div>
        </div>
    <?php } elseif ($show_advanced_search_candidates && is_page(iwj_get_page_id('candidates'))) { ?>
        <div class="page-heading jobs">
            <div class="container-inner">
                <div class="container">
                    <?php
                    echo do_shortcode('[iwj_advanced_search_candidates]');
                    ?>
                </div>
            </div>
        </div>
    <?php } else { ?>
        <div class="page-heading default">
            ...
            <?php
            if (!is_page_template( 'page-templates/home-page.php' ) && $show_breadcrums && $show_breadcrums != 'no' && !is_front_page()) {?>
