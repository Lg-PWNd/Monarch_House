...
?>
<div class="header header-default header-style-default v5 <?php echo esc_attr( implode( ' ', $header_class ) ); ?> ">
				...
				<div class="btn-action-wrap">
                        ...
                        if ( $user ) {
                            ...
                            <div class="author-login">
                                <a href="<?php echo esc_url( $dashboard_url ); ?>">
                                    <span class="author-avatar"><?php echo get_avatar( $user->get_id(), 32 ); ?></span>
                                </a>
                    ...
                    <?php if ( class_exists( 'IWJ_Class' ) ) {
                        ...
                        if ( $user ) {
                            ...
                            <div class="author-login">
                                <a href="<?php echo esc_url( $dashboard_url ); ?>">
                                    <span class="author-avatar"><?php echo get_avatar( $user->get_id(), 25 ); ?></span>
                                    <span class="author-name">
                                        <?php echo (string) $user->get_display_name(); ?>
                                    </span>
                                </a>
                                <div class="iwj-dashboard-menu">
                                    <?php iwj_get_template_part( 'dashboard-menu', array( 'tab' => $tab ) ) ?>
