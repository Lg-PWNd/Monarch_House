...
?>
<div class="header header-default header-style-default v3 v4 <?php echo esc_attr( implode( ' ', $header_class ) ); ?> ">
		...
		<div class="navbar-default-inner">
			...
			<div class="header-btn-action">
				<div class="btn-action-wrap">
					...
					<?php
					if ( ( is_user_logged_in() && current_user_can( 'create_iwj_jobs' ) && ! iwj_option( 'disable_employer_register' )) ) { ?>
                    ...
                    <?php if ( class_exists( 'IWJ_Class' ) ) {
                        ...
                        <?php
                            ...
                            if ( ! $disable_candidate_register || ! $disable_employer_register ) {
                                $active_class = "";
                                echo '<a class="register active" href="' . esc_url( iwj_get_page_permalink( 'register' ) ) . '" onclick="return InwaveRegisterBtn();"><span>' . __( 'register', 'injob' ) . '</span><i class="fa fa-user"></i></a>';
                            }
                            echo '<a class="login ' . $active_class . '" href="' . esc_url( iwj_get_page_permalink( 'login' ) ) . '" onclick="return InwaveLoginBtn();"><span>' . __( 'login', 'injob' ) . '</span><i class="fa fa-user-plus"></i></a>';
                            echo '</span>';
                        }
