...
if ( ! $checkout->enable_signup && ! $checkout->enable_guest_checkout && ! is_user_logged_in() ) {
	echo apply_filters( 'woocommerce_checkout_must_be_logged_in_message', esc_html__( 'You must be logged in to checkout.', 'iwjob' ) );
	return;
}
			...
			<div class="row">
					...
					<div class="checkout-row col-md-6 col-sm-6 col-xs-12">
						...
						<div class="checkout-box checkout-box-order">	
							<div id="order_review_heading" class="title"><?php esc_html_e( 'Your order', 'iwjob' ); ?></div>
							<div class="box">
...
<!--	<div id="order_review" class="woocommerce-checkout-review-order">
		<div class="row">
			<div class="checkout-row col-md-6">
				<div id="order_review_heading" class="title"><?php esc_html_e( 'Your order', 'iwjob' ); ?><i class="fa fa-minus-square-o"></i></div>
				<div class="box">
			<?php do_action( 'woocommerce_checkout_order_review' ); ?>
				</div>
			</div>
