<div class="iwj-thankyou-page">
    ...
    <div class="thankyou-panel">
        <h3><?php echo __('Check your email to confirm','iwjob');?></h3>
        <div class="success-txt">
            <p><?php echo __('An email has been sent to your email please confirm it to complete the registration','iwjob');?></p>
        </div>
        <ul>
            <li>
