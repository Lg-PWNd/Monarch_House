    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo __('Register for new job alert', 'iwjob'); ?></h4>
            ...
            <div class="modal-body">
                <form action="<?php echo get_permalink(); ?>" method="post" class="iwj-form-2 iwj-alert-submit-form iwj-alert-submit-form-popup">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?php
                            iwj_field_text('name', __('Your Name *', 'iwjob'), true, 0, '', '','', __('Enter your name', 'iwjob'));
                            ?>
                        </div>
                    </div>
                    <?php } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="<?php echo $class; ?>">
                            <?php
                            iwj_field_taxonomy2('iwj_cat','categories', __('Categories', 'iwjob'), false, 0, null, null, '', __('Select Categories', 'iwjob'), true);
                            ?>
                        </div>
                        <?php if(!$disable_type){ ?>
                            <div class="<?php echo $class; ?>">
