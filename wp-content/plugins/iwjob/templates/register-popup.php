<div id="iwj-register-popup" class="modal-popup modal fade iwj-register-form-popup">
    <div class="modal-dialog">
        <div class="modal-header">
            <h4 class="modal-title"><?php echo __('Register Account', 'iwjob'); ?></h4>
                    ...
                    <?php if(!$disable_candidate_register && !$disable_employer_register){ ?>
                        <div class="iwj-magic-line-wrap">
                            <div class="iwj-magic-line">
                                <p class="active iwj-toggle iwj-candidate-toggle"><?php echo __('Candidate', 'iwjob'); ?></p>
                                <p class="iwj-toggle iwj-employer-toggle"><?php echo __('Employer', 'iwjob'); ?></p>
                            </div>
                        </div>
                    <?php } ?>
