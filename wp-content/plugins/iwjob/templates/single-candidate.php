...
$login_page_id                 = get_permalink( iwj_option( 'login_page_id' ) ); ?>
	<div class="iwj-candicate-detail">
		<div class="container">
			<div class="row">
				<?php
				...
				if ( ! $check ) {?>
					...
					if ( $check == 2 ) { ?>
						...
						<div class="<?php echo esc_attr( inwave_get_classes( 'container', $candidate_sidebar ) ); ?>">
							<div class="iwj-candidate-info-top">
                                <div class="bg-overlay"></div>
                                <div class="info-top">
                                    <div class="candidate-logo">
                                        <?php echo $candidate->get_avatar( 150 ); ?>
                                    ...
                                    <div class="info-inner">
                                        ...
                                        <?php if ( iwj_option( 'view_free_resum' ) || ( $user && $user->can_view_resum( $candidate->get_id() ) ) ) { ?>
                                                ...
                                                <ul>
                                                    <?php if ( $candidate->get_address() ) { ?>
                                                        <li class="candidate-location">
                                                            ...
                                                            <span class="info-value"><?php echo $candidate->get_address(); ?></span>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if ( $candidate->get_phone() ) { ?>
                                                        <li class="candidate-phone">
                                                            <i class="ion-ios-telephone"></i>
                                                            <span class="info-value"><?php echo $candidate->get_phone(); ?></span>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if ( $candidate->get_email() ) { ?>
                                                        <li class="candidate-email">
                                                            <i class="ion-android-globe"></i>
                                                            <span class="info-value"><?php echo $candidate->get_email(); ?></span>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
                                            <div class="iwj-button-loader detail-action-button">
                                                <?php if ( current_user_can( 'create_iwj_jobs' ) ) {
                                                    ...
                                                    $save_text = $saved ? __( '<i class="ion-android-send"></i> Saved resume', 'iwjob' ) : __( '<i class="ion-android-send"></i> Save resume', 'iwjob' );
                                                    ?>
                                                ...
                                                <?php } elseif ( ! $user ) { ?>
                                                    <a href="#" data-toggle="modal" data-target="#iwj-login-popup" class="iwj-btn action-button follow"><?php echo __( '<i class="ion-android-send"></i> Save resume', 'iwjob' ); ?></a>
                                                <?php } ?>
                                                <?php
                                                $cv = $candidate->get_cv();
                                        ...
                                        <?php } else { ?>
                                            <div class="view-infomation detail-action-button">
                                                <?php if ( current_user_can( 'create_iwj_jobs' ) ) { ?>
                                                    <a href="#" data-toggle="modal" data-target="#iwj-modal-view-<?php echo $candidate->get_id(); ?>"><i class="ion-ios-eye"></i><?php echo __( 'View full infomation', 'iwjob' ); ?>
                                                    </a>
                                                <?php } elseif ( ! $user ) { ?>
                                                    <a href="#" data-toggle="modal" data-target="#iwj-login-popup"><i class="ion-ios-eye"></i><?php echo __( 'View full infomation', 'iwjob' ); ?>
                                                    </a>
                                                <?php } else { ?>
