...
<div class="iwj-jobs page">
    <div class="container">
        <div class="row">
            <?php if ($jobs_sidebar && $jobs_sidebar == 'both') { ?>
                <div class="col-md-3">
                    <div class="widget-area iwj-sidebar-1">
                        <?php dynamic_sidebar('sidebar-jobs-1'); ?>
                    </div>
                </div>
            <?php }elseif($jobs_sidebar && $jobs_sidebar == 'left'){ ?>
                <div class="col-md-4">
                    <div class="widget-area iwj-sidebar-1">
                        <?php dynamic_sidebar('sidebar-jobs-1'); ?>
                    </div>
            ...
            <?php
            $content_class = ($jobs_sidebar && $jobs_sidebar == 'both') ? 'iwj-content col-md-6' : ($jobs_sidebar ? 'col-md-8' : 'col-md-12');
            ?>
            ...
            <?php if($jobs_sidebar && $jobs_sidebar == 'both'){ ?>
            <div class="col-md-3">
                <div class="widget-area iwj-sidebar-2">
                <?php
                dynamic_sidebar('sidebar-jobs-2');
                ?>
                </div>
            </div>
            <?php }elseif($jobs_sidebar && $jobs_sidebar == 'right'){
                ?>
                <div class="col-md-4">
                    <div class="widget-area iwj-sidebar-2">
