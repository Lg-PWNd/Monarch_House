    ...
    <div class="iwj-table-overflow-x">
        <table class="table">
            ...
            <tr>
                ...
                <th width="50%"><?php echo __('Criterias ', 'iwjob'); ?></th>
                        ...
                        <tr id="alert-<?php echo $alert->get_id(); ?>">
                            ...
                            <td>
                                ...
                                <a href="#" class="iwj-delete-alert" data-id="<?php echo $alert->get_id(); ?>"
                                   data-message="<?php printf(__('Are you sure want to delete %s?', 'iwjob'), $alert->get_position()); ?>"><?php echo __('Delete', 'iwjob'); ?></a>
                            </td>
                        </tr>
                    <?php
                    }
