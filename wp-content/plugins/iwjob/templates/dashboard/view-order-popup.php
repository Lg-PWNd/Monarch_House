...
?>
<div class="iwj-order-details order-popup">
    <?php
    if ( $order ) {
            ...
            <table class="order_details table">
                ...
                <tr>
                    <?php if($order_type == 1 || $order_type == 4 || $order_type == 6){?>
                        ...
                        <td>
                            ...
                            echo $package ? $package->get_title() : $order->get_package_title();
                            ?>
                        </td>
                    <?php }elseif($order_type == 2 || $order_type == 3){ ?>
                        ...
                        <td>
                            <?php
                            $job = $order->get_job();
                            echo $job ? $job->get_title() : $order->get_job_title();
                            ?>
                        </td>
                    <?php } ?>
                </tr>
                ...
                <?php if($order->has_status('publish')){ ?>
                    <tr>
