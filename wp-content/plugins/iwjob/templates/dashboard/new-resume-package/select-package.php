<?php
    $package_query = IWJ_Resume_Package::get_packages();
?>
<div class="iwj-select-package">
	
	<form method="post" action="" class="iwj-select-package-form">
		<h3 class="iwj-title-table"><?php echo __('Choose new resume package', 'iwjob');?></h3>
        <div class="iwj-table-overflow-x">
            <table>
                <tr class="package-heading">
                    ...
                    <th><?php echo __('Resumes', 'iwjob'); ?></th>
                </tr>
                ...
                while ($package_query->have_posts()) {
                    ...
                    <tr class="package-item">
                        ...
                        <td class="package-job">
                            <?php
                            echo (int)$package->get_number_resume();
                            ?>
                        </td>
                    </tr>
                    <?php
		...
		<?php wp_nonce_field( 'iwj-new-resume-package', 'iwj-security'); ?>
