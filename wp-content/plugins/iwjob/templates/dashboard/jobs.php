        ...
        <div class="iwj-table-overflow-x">
            <table class="table">
                ...
                <?php if($job_query->have_posts()) { ?>
                    ...
                    while ($job_query->have_posts()){
                        ...
                        <tr class="job-item status-<?php echo $job->get_status(); ?>" id="job-<?php echo $job->get_id(); ?>">
                            <td class="job-title-meta">
                                ...
                                <ul class="job-meta">
                                    ...
                                    <?php if ($job->get_locations_links()) { ?>
                                        <li class="locations"><i class="fa fa-map-marker"></i> <?php echo $job->get_locations_links(); ?></li>
                                    <?php } ?>
                                </ul>
                            </td>
                            ...
                            <td class="job-featured <?php echo ($job->is_featured() || $job->is_pending_featured()) ? 'featured' : ''; ?>">
                                <?php if ($job->is_featured() || $job->is_pending_featured()){ ?>
                                    <i class="fa fa-star"></i>
                                <?php } elseif($job->can_make_featured()) { ?>
                                    <a href="<?php echo $job->make_featured_link(); ?>" data-toggle="tooltip" title="<?php echo __('Make featured', 'iwjob'); ?>"><?php echo __('<i class="fa fa-star-o"></i>', 'iwjob'); ?></a>
                                <?php }else{?>
                                    ...
                                    <div id="nav-collapse<?php echo $post->ID; ?>" class="collapse iwj-menu-action" data-id="nav-collapse<?php echo $post->ID; ?>">
                                        <div class="iwj-menu-action-inner">
                                            ...
                                            <?php if($job->can_delete()){ ?>
                                                <div><a href="#" class="iwj-delete-job" data-id="<?php echo $job->get_id(); ?>" data-message="<?php printf(__('Are you sure want to delete %s?', 'iwjob'), $job->get_title()); ?>"><?php echo __('Delete', 'iwjob'); ?></a></div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <tr class="iwj-empty">
                        <td colspan="8"><?php echo __('No job found', 'iwjob'); ?></td>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
