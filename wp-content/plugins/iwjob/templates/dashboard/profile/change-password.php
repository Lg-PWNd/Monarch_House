<div class="iwj-change-password iwj-block">
    ...
    <div class="iwj-button-loader">
        ...
        <button type="button" class="iwj-btn iwj-btn-iwj-btn-danger iwj-delete-account-btn" data-confirm-delete="<?php echo __("Are you sure want to delete your account?", 'iwjob'); ?>"><?php echo __('Delete My Account', 'iwjob');?></button>
        <?php } ?>
    </div>
    </form>
</div>