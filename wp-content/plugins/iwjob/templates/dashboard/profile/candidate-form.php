    ...
    <form method="post" action="" class="iwj-form-2 iwj-candidate-form">
        ...
        <div class="iwj-block">
            <div class="basic-area iwj-block-inner">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        iwj_field_text('your_name', __('Your Name *', 'iwjob'), true, $post_id, $value, '', '', __('Enter your name', 'iwjob'));
                    ...
                    <div class="col-md-6">
                        <?php
                        //phone
                        iwj_field_text(IWJ_PREFIX.'phone', __('Phone *', 'iwjob'), true, $post_id, null, '', '', __('Enter your phone', 'iwjob'));
            ...
            <div class="working-preferences-area iwj-block-inner">
                ...
                <div class="row">
                    <div class="<?php echo $class; ?>">
                        <?php
                        iwj_field_taxonomy2('iwj_cat','categories', __('Categories *', 'iwjob'), true, $post_id, null, array(), '', __('Select Categories', 'iwjob'), true, array(), array('numberDisplayed' => 2));
                        ?>
                    </div>
                    <?php if(!$disable_type){ ?>
                    <div class="<?php echo $class; ?>">
                    ...
                    <div class="<?php echo $class; ?>">
                        <?php
                        iwj_field_taxonomy('iwj_level','levels', __('Levels *', 'iwjob'), true, $post_id, null, array(), '', __('Select Level', 'iwjob'), true);
                        ?>
                    </div>
                    <?php } ?>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <?php
                        iwj_field_taxonomy2('iwj_location','locations', __('Locations *', 'iwjob'), true, $post_id, null, array(), '', __('Select Locations', 'iwjob'), true, array(
                            'hide_empty' => false,
                            'parent' => 0,
                        ), array('numberDisplayed' => 2));
                        ?>
                    </div>
	                <?php if(!$disable_language){ ?>
                    <div class="col-md-4">
                        <?php
            ...
            <div class="gallery-area iwj-block-inner">
                <h3><?php echo __('Gallery', 'iwjob'); ?></h3>
                <?php
            ...
            <div class="socials-area iwj-block-inner">
                <h3><?php echo __('Company Socials', 'iwjob'); ?></h3>
                <div>
                    <div class="row">
                        <div class="col-md-6">
                            <?php
