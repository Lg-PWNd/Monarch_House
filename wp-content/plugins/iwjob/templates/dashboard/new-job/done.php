                ...
                <div class="thankyou-panel">
                    ...
                    <div class="success-txt">
                        ...
                        <?php }elseif($job->has_status('pending')){ ?>
							...
							<p><?php echo sprintf(__('hank you for submitting, this job is being reviewed. If you need help please contact us via email <a href="mailto:%s">%s</a>', 'iwjob'), $admin_email_receiver, $admin_email_receiver); ?></p>
                        <?php }elseif($job->has_status('pending-payment')){ ?>
                            <span class="job-pending"><i class="ion-ios-clock-outline"></i></span>
							<p><?php echo sprintf(__('hank you for submitting, this job is being payment. If you need help please contact us via email <a href="mailto:%s">%s</a>', 'iwjob'), $admin_email_receiver, $admin_email_receiver); ?></p>
                        <?php } ?>
                    </div>
                    <ul>
                        <li>
