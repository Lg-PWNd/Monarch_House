        ...
        <div class="iwj-table-overflow-x">
            <table>
                <tr>
                    ...
                    <th class="text-center"><?php echo __('Jobs Remaining', 'iwjob');?></th>
                        ...
                        if($user_package->can_submit()) {
                            ...
                            <tr class="package-item">
                                ...
                                <td class="package-remain-job text-center">
                                    <?php
                                    echo (int)$user_package->get_remain_job();
                                    ?>
                                </td>
                                <td class="package-remain-featured-job text-center">
                                    <?php
                                    echo (int)$user_package->get_remain_featured_job();
                                    ?>
                                </td>
                                <td class="package-remain-renew-job text-center">
                                    <?php
                                    echo (int)$user_package->get_remain_renew_job();
                                    ?>
                                </td>
        ...
        <div class="iwj-table-overflow-x">
            <table>
                <tr>
                    ...
                    <th class="text-center"><?php echo __('Jobs Posting', 'iwjob'); ?></th>
                    <th class="text-center"><?php echo __('Feature Jobs', 'iwjob'); ?></th>
                    <th class="text-center"><?php echo __('Renew Jobs', 'iwjob'); ?></th>
                    <th><?php echo __('Duration', 'iwjob'); ?></th>
                </tr>
                        ...
                        if($package->can_buy()){
                            ...
                            <tr class="package-item">
                                ...
                                <td class="package-job text-center">
                                    <?php
                                    echo (int)$package->get_number_job();
                                    ?>
                                </td>
                                <td class="package-featured-job text-center">
                                    <?php
                                    echo (int)$package->get_number_featured_job();
                                    ?>
                                </td>
                                <td class="package-renew-job text-center">
                                    <?php
                                    echo (int)$package->get_number_renew_job();
                                    ?>
                                </td>
                                <td class="package-duration">
                                    <?php
