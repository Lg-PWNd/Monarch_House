<form action="" method="post" class="iwj-form-2 iwj-job-payment-form">
    <div class="iwj-order-payment">
        <div class="iwj-order">
            <h3><?php echo sprintf(__('Submit Job: %s', 'iwjob'), $job->get_title()); ?></h3>
            <div class="iwj-order-price">
                <?php
                echo '<div>';
                $total_price = $price = (int)iwj_option('job_price');
    ...
    <input type="hidden" name="job_id" value="<?php echo $job->get_id(); ?>">
    <?php wp_nonce_field( 'iwj-payment-job', 'iwj-submit-job'); ?>
