    ...
    <div class="iwj-table-overflow-x">
        <table class="table">
            ...
            <tr>
                ...
                <th width="40%" class="text-center"><?php echo __('Opening Jobs', 'iwjob'); ?></th>
                                ...
                                <div class="follow-content">
                                    ...
                                    <div class="employer-meta">
                                        ...
                                        <?php if($location_links = $employer->get_locations_links()){ ?>
                                            <div class="location">
                                                <span class="meta-title"><i class="fa fa-map-marker"></i></span>
                                            <span class="meta-value">
                                        ...
                                        <div class="iwj-menu-action-inner">
                                            <div>
                                                <a href="#" class="iwj-unfollow" data-id="<?php echo $item->post_id; ?>"
                                                   data-message="<?php printf(__('Are you sure want to remove %s?', 'iwjob'), $employer->get_display_name()); ?>"><?php echo __('Delete', 'iwjob'); ?>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
