            ...
            <div class="basic iwj-block-inner">
                ...
                <div class="row">
                    <div class="<?php echo $class; ?>">
                        ...
                        $placeholder = _n('Select A Category', 'Select Categories *', $max_categories, 'iwjob');
                        if(!$multiple){
                            ...
                            iwj_field_taxonomy2('iwj_cat','job_category', __('Job Category *', 'iwjob'), true, $post_id, null, null, '', $placeholder, $multiple, array(), array(
