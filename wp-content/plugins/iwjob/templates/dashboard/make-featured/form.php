...
?>
<form action="" method="post" class="iwj-form-2 iwj-make-featured-form">
    <div class="iwj-order-payment">
        <div class="iwj-order">
            <h3><?php echo sprintf(__('Make featured: %s', 'iwjob'), $job->get_title()); ?></h3>
                    ...
                    <?php
                        if($user_package && $user_package->can_make_featured()){
                            ...
                            <div class="iwj-your-package">
                                ...
                                <div><?php echo sprintf(__('Remaining Featured: %s', 'iwjob'), $user_package->get_remain_featured_job()); ?></div>
                            </div>
                            <?php
                        }else{
							echo '<div>';
                            $total_price = $price = (int)iwj_option('featured_job_price');
    ...
    <?php wp_nonce_field( 'iwj-make-featured', 'iwj-security'); ?>
