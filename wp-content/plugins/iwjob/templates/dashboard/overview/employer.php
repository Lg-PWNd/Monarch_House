                ...
                <div class="empl-info-jobs-item">
                    <div class="empl-box jobs-listing">
                        <div class="empl-small-detail">
                            ...
                            <a href="<?php echo add_query_arg( array( 'iwj_tab' => 'jobs' ), $dashboard_url ); ?>"><?php echo esc_html__('All job listings', 'iwjob') ?></a>
                        </div>
                    </div>
                </div>
                <div class="empl-info-jobs-item">
                    <div class="empl-box jobs-published">
                        <div class="empl-small-detail">
                            ...
                            <a href="<?php echo add_query_arg( array( 'iwj_tab' => 'jobs', 'status' => 'publish' ), $dashboard_url ); ?>"><?php echo _n('Published Job', 'Published Jobs', $total_publish_jobs, 'iwjob') ?></a>
                        </div>
                    </div>
                </div>
                <div class="empl-info-jobs-item">
                    <div class="empl-box jobs-expired">
                        <div class="empl-small-detail">
                            ...
                            <a href="<?php echo add_query_arg( array( 'iwj_tab' => 'jobs', 'status' => 'iwj-expired' ), $dashboard_url ); ?>"><?php echo _n('Expired Job', 'Expired Jobs',$total_expired_jobs, 'iwjob') ?></a>
                        </div>
                    </div>
                </div>
                <div class="empl-info-jobs-item">
                    <div class="empl-box jobs-pending">
                        <div class="empl-small-detail">
                            <h5><?php
                                 $total_pending_jobs = $user->count_jobs_with_status('pending');
                                 echo $total_pending_jobs;
                                 ?>
                            </h5>
                            <a href="<?php echo add_query_arg( array( 'iwj_tab' => 'jobs', 'status' => 'pending' ), $dashboard_url ); ?>"><?php echo _n('Pending Job', 'Pending Jobs', $total_pending_jobs, 'iwjob') ?></a>
                        </div>
                    </div>
                </div>
            </div>
					...
					<div class="iwj-table-overflow-x">
						<table class="table">
							...
							if ( $job_query->have_posts() ) {
                                ...
                                <?php if ($j > 5) { ?>
                                    <tr>
                                        <td colspan="3" class="text-right"><div class="view-all"><a href="<?php echo add_query_arg( array( 'iwj_tab' => 'jobs' ), $dashboard_url ); ?>"><?php echo esc_html__('View All Jobs', 'iwjob') ?></a></div></td>
                                    </tr>
                                <?php } ?>
							<?php } else { ?>
								<tr class="iwj-empty">
									<td colspan="3"><?php echo __( 'Your jobs will be displayed here', 'iwjob' ); ?></td>
								</tr>
							<?php } ?>
							</tbody>
						</table>
