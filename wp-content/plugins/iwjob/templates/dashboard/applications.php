										...
										<div class="iwj-menu-action-inner">
											...
											<?php }
												if( iwj_option('employer_can_delete_application') ){?>
													<div><a href="#" class="iwj-delete-application" data-id="<?php echo $application->get_id(); ?>" data-message="<?php printf(__('Are you sure want to delete %s?', 'iwjob'), $application->get_title()); ?>"><?php echo __('Delete', 'iwjob'); ?></a></div>
												<?php }
											?>
										</div>
									</div>
