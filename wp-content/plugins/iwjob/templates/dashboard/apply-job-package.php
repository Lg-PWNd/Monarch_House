...
$user_package_query = $user->get_user_packages('apply_job_package');
$dashboard = iwj_get_page_permalink('dashboard');
?>
<div class="iwj-user-packages iwj-main-block">
	<div class="add-new-package">
		<a class="iwj-btn iwj-btn-primary" href="<?php echo add_query_arg(array('iwj_tab' => 'new-apply-job-package'), $dashboard) ; ?>"><?php echo __('New Apply Job Package', 'iwjob'); ?></a>
	</div>
	<div class="iwj-user-packages-table iwj-table-overflow-x">
		<table class="table">
			...
			<tr class="package-heading">
				...
				<th width="20%"><?php echo __('Apply Job Remaining', 'iwjob');?></th>
			...
			<?php if($user_package_query->have_posts()) {
				while ($user_package_query->have_posts()){
					...
					<tr class="package-item">
						...
						<td class="package-remain">
							<span><?php echo $user_package->get_remain_apply_job() ?></span>
						</td>
				...
				<tr class="iwj-empty">
					<td colspan="4"><?php echo __('You have not any packages yet.', 'iwjob'); ?></td>
				</tr>
			<?php } ?>
			</tbody>
		</table>
