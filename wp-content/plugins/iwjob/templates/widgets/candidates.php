...
?>
	<div class="iwj-widget-candidates owl-carousel">
		<?php foreach ( $candidates as $candidate ) :
			...
			$image = get_avatar( $candidate->get_author_id(), 100 );
			if ( $candidate->get_public_account() ):?>
				<div class="candidate-item">
					...
					<div class="candidate-info">
						<div class="info-top">
							...
							<a class="view-candidate" href="<?php echo $link_profile; ?>"><?php echo __( "View Resume", "iwjob" ); ?></a>
						</div>
					</div>
				</div>
