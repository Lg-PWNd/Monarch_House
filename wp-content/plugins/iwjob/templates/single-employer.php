							...
							<div class="employer-info-top">
                                ...
                                <div class="info-top">
                                    <div class="employer-logo">
                                        <?php echo $employer->get_avatar( 150 ); ?>
                                    ...
                                    <div class="conttent-right">
                                        <div class="title-location">
                                            <h3 class="title"><?php echo $employer->get_title(); ?></h3>
														...
														if ( $item_review->status == 'approved' ) {
															...
															<div class="iwj-review-item" id="vote-employer-id-<?php echo esc_attr( $item_review->ID ); ?>">
																<div class="review-avatar">
																	<img src="<?php echo get_avatar_url( $item_review->user_id ); ?>" alt="<?php echo esc_attr__( $user_post->get_display_name(), 'iwjob' ); ?>" />
																</div>
																	...
																	if ( $check_reply_review ) { ?>
																		<div class="iwj-author-reply">
																			<div class="iwj-reply-author-avatar">
																				<img src="<?php echo get_avatar_url( $employer->get_author_id(), array( 'size' => 60 ) ); ?>" alt="<?php echo esc_attr__( $employer->get_display_name(), 'iwjob' ); ?>" />
																			</div>
															...
															<div class="re-post-form-submit">
																...
																<div class="iwj-rate-stars" data-rate_type="<?php echo ! empty( $trim_rate ) ? 'group_rate' : 'simple_rate'; ?>">
																	...
																	if ( ! empty( $trim_rate ) ) {
																		$arr_reviews = explode( "\n", $review_option );
																		?>
																		<span class="re-text"><?php esc_html_e( 'Ovaral Rating:', 'iwjob' ); ?></span>
