				...
				<div class="modal-body">
					...
					if ( $show_form ) {
						...
						switch ( $apply_form ) {
							...
							case 2: ?>
								<div class="iwj-alert-box">
									<?php echo sprintf( __( 'You must buy Apply Job package before apply job. <a href="%s">Buy now</a>', 'iwjob' ), add_query_arg( array( 'iwj_tab' => 'new-apply-job-package' ), $dashboard_url ) ); ?>
								</div>
								<?php
								break;
							case 3: ?>
								<div class="iwj-alert-box">
									<?php echo sprintf( __( 'Your Apply Job package is pending or expired. <a href="%s">Check now</a>', 'iwjob' ), add_query_arg( array( 'iwj_tab' => 'apply-job-package' ), $dashboard_url ) ); ?>
								</div>
								<?php
								break;
							case 1:
							case 4:
								...
								<div class="iwj-btn-action">
									...
									<div class="iwj-button-loader">
										<button type="submit" class="iwj-btn iwj-btn-primary iwj-application-btn"><?php echo __( 'Apply Now', 'iwjob' ); ?></button>
									</div>
								</div>
								<?php
								break;
