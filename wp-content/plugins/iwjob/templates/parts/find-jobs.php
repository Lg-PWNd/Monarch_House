    ...
    <form action="<?php echo esc_url(iwj_get_page_permalink('jobs')) ?>" method="get">
        ...
        <div class="fields">
            ...
            <div class="field-item categories">
                <div class="field-content select">
                    <label><?php echo __("Categories", 'iwjob') ?>?</label>
                    <i class="fa fa-suitcase"></i>
                    <div class="input-select">
                        <select class="iwj-find-jobs-select <?php echo $style; ?>" name="iwj_cat">
                            <option value="" selected="selected"><?php echo __("All categories", 'iwjob') ?></option>
                            <?php if($categories){
        ...
        <div class="trending-keywords">
            <span class="title"><?php echo __("Trending Keywords", 'iwjob') ?>:</span>
