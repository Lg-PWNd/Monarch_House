        ...
        <div class="section-filter filter-advance">
            ...
            <div class="default-fields">
                ...
                <div class="filter-item-keyword">
                    <input class="form-control keywords" type="text" name="keyword" placeholder="<?php echo __('Enter keywords ( Job title, skills, company, etc... )', 'iwjob'); ?>" value="<?php echo $keyword; ?>">
                </div>
