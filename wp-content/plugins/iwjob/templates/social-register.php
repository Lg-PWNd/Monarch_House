<div class="iwj-social-register">
    <?php if(!is_user_logged_in()) { ?>
        <form action="" method="post" class="iwj-form iwj-register-form iwj-social-register">
            ...
            <div class="iwj-field">
                <label><?php echo __('Your Name', 'iwjob'); ?></label>
                <div class="iwj-input">
                    <i class="fa fa-user"></i>
                    <input type="text" name="display_name" placeholder="<?php echo __('Enter Your Username.', 'iwjob'); ?>" value="<?php echo $display_name; ?>" required>
                </div>
            </div>
            <div class="iwj-field">
                ...
                <div class="iwj-field">
                    ...
                    <div class="iwj-input">
                        ...
                        <select type="select" name="role" class="iwj-role iwj-select-2-wsearch">
                            <option value="candidate"><?php echo __('Candidate', 'iwjob'); ?></option>
                            <option value="employer"><?php echo __('Employer', 'iwjob'); ?></option>
                        </select>
                    </div>
                </div>
            <?php }
