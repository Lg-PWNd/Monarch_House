...
class IWJ_Admin{
    ...
    static function admin_load_scripts(){
        ...
        $js_version = false;
        wp_register_script('google-maps', 'https://maps.googleapis.com/maps/api/js?key='.$google_api_key.'&libraries=places&sensor=false', array('jquery'), $js_version, true);
        ...
        wp_localize_script('iwj-admin', 'iwjadmin', array(
            'i18n_delete_note' => __('Are you sure you wish to delete this note? This action cannot be undone.', 'iwjob'),
    ...
    static function admin_menu(){
	    ...
	    add_submenu_page('edit.php?post_type=iwj_job', __('Tools', 'iwjob'), __('Tools', 'iwjob'), 'manage_options', 'iwj-jobs-tools', array('IWJ_Admin_Jobs_Tools', 'management_page') );
	    ...
	    add_menu_page(__('Indeed Job Imports', 'iwjob'), __('Indeed Job Imports', 'iwjob'), 'manage_options', 'iwj-indeed-imports', array('IWJ_Admin_Indeed_Imports', 'management_page'),'dashicons-vault', 26);
    }
    ...
    static function admin_notices(){
        $setting_pages = array(
            ...
            'jobs' => __('Jobs Page', 'iwjob'),
            'candidates' => __('Candidates Page', 'iwjob'),
            'employers' => __('Employers Page', 'iwjob'),
            'suggest_job' => __('Job Suggestion Page', 'iwjob'),
            'candidate_suggestion' => __('Candidate Suggestion Page', 'iwjob'),
        );
