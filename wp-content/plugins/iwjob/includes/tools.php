					...
					array(
						...
						'options' => array(
							array(
								...
								'options'  => array(
									'iwj_job'       => esc_html__( 'Jobs', 'iwjob' ),
									'iwj_employer'  => esc_html__( 'Employers', 'iwjob' ),
									'iwj_candidate' => esc_html__( 'Candidates', 'iwjob' ),
								),
					...
					<span class="select_box" style="width:200px;height:40px;">
						  <select class="search_dropdown selectpicker" id="search_dropdowns" data-size="5" name="posttype" style="width:200px;height:39px;">
							  ...
							  $post_types = array(
								  ...
								  'iwj_candidate' => __( 'Candidate', 'iwjob' ),
								  'iwj_employer'  => __( 'Employer', 'iwjob' ),
							  );
		...
		<div class="template_body whole_body">
			<form class="form-inline" method="post">
				...
				<div class="event-summary timer">
					...
					<span class="es-right" id="iwj_import_current" style="padding-right:7px;color:green;"> <?php echo esc_html__( 'Current Processing Record:', 'iwjob' ); ?> </span>
				</div>
				<div class="control" style="display: none;">
					...
					<input type="button" id="iwj_import_timer_count_down" onClick="timer.mode(0)" value="<?php echo esc_attr__( 'Count down', 'iwjob' ); ?>" />
				</div>
