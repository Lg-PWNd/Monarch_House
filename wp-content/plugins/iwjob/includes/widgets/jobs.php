<?php
/**
 * Widget API: IWJ_Widget_Jobs class
 *
 * @package WordPress
 * @subpackage Widgets
 * @since 4.4.0
...
class IWJ_Widget_Jobs extends WP_Widget {

    public function __construct() {
        $widget_ops = array(
            'description' => esc_html__( 'Display Jobs List.', 'iwjob' ),
            'customize_selective_refresh' => true,
        );
        parent::__construct( 'iwj_jobs', esc_html__( '[IWJ] Jobs', 'iwjob' ), $widget_ops );
    }
    ...
    public function form( $instance ) {
        $instance = wp_parse_args( (array) $instance, array( 'title' => __('Latest Jobs', 'iwjob'), 'limit'=>5 , 'orderby' => 'date', 'order' => 'DESC') );
...
function iwj_widget_jobs() {
    register_widget('IWJ_Widget_Jobs');
}
