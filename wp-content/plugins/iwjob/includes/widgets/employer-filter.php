...
class IWJ_Widget_Employer_Filter extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'description' => esc_html__( 'Filter Employers Widget.', 'iwjob'),
            'customize_selective_refresh' => true,
        );
        parent::__construct( 'iwj_employer_filter', esc_html__( '[IWJ] Filter Employers', 'iwjob'), $widget_ops );
    }
    ...
    public function form( $instance ) {
        $instance = wp_parse_args( (array) $instance, array( 'title' => __('Employer Filter', 'iwjob') ) );
