...
class IWJ_Widget_Simple_Search extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct( 'iwj_simple_search', esc_html__( '[IWJ] Simple Search Job', 'iwjob'), $widget_ops );
    }

    public function widget( $args, $instance ) {

            /** This filter is documented in wp-includes/widgets/class-wp-widget-pages.php */
            $title = (!empty($instance['title'])) ? $instance['title'] : __('Job search', 'iwjob');
            ...
            <div class="job-search sidebar-job-1">
                <form name="iwjob-search" id="iwjob-search">
                    <div class="input-group">
                        <input name="keyword" type="text" class="form-control" placeholder="<?php echo __('Search', 'iwjob'); ?>" value="<?php echo esc_html($keyword); ?>">
    ...
    public function form( $instance ) {
        $instance = wp_parse_args( (array) $instance, array( 'title' => __('Job search', 'iwjob') ) );
        ...
        <p>
            ...
            <select name="<?php echo $this->get_field_name( 'type' ); ?>">
                ...
                <option <?php echo ($type == 'candidate') ? 'selected' : ''; ?> value="candidate"><?php echo __('Candidate', 'iwjob'); ?></option>
                <option <?php echo ($type == 'employer') ? 'selected' : ''; ?> value="employer"><?php echo __('Employer', 'iwjob'); ?></option>
            </select>
        </p>
        <?php
    }
