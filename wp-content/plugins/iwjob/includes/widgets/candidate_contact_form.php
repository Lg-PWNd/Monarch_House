...
class IWJ_Widget_Candidate_Contact_Form extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'description' => esc_html__( 'Display Candidate Contact Form, used only with sidebar employer details.', 'iwjob' ),
            'customize_selective_refresh' => true,
        );
        parent::__construct( 'iwj_candidate_contact_form', esc_html__( '[IWJ] Candidate Contact Form', 'iwjob' ), $widget_ops );
    }
