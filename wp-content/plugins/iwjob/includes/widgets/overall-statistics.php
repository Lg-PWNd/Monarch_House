...
class IWJ_Widget_Overall_Statistics extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('show_employers')); ?>"><?php esc_html_e('Show Employers:', 'iwjob'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('employers')); ?>"><?php esc_html_e('Employers:', 'iwjob'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('show_resums')); ?>"><?php esc_html_e('Show Resums:', 'iwjob'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('show_jobs')); ?>"><?php esc_html_e('Show Jobs:', 'iwjob'); ?></label>
