...
class IWJ_Widget_Employer_Infomation extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'description' => esc_html__( 'Display Employer Infomation, used only with sidebar employer details.', 'iwjob' ),
            'customize_selective_refresh' => true,
        );
        parent::__construct( 'iwj_employer_infomation', esc_html__( '[IWJ] Employer Infomation' , 'iwjob'), $widget_ops );
    }
