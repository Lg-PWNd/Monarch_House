...
class IWJ_Widget_Job_Infomation extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'description' => esc_html__( 'Display Job Infomation, used only with sidebar job details.', 'iwjob' ),
            'customize_selective_refresh' => true,
        );
        parent::__construct( 'iwj_job_infomation', esc_html__( '[IWJ] Job Infomation', 'iwjob' ), $widget_ops );
    }
