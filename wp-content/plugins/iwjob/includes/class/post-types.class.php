...
class IWJ_Post_Types
{
    ...
    static function register_post_types(){
        ...
        //Resigter Employer
        $labels = array(
            'name' 					=> __('Employers', 'iwjob'),
            'singular_name' 		=> __('Employer', 'iwjob'),
            'add_new' 				=> __('Add New', 'iwjob'),
            'all_items' 			=> __('Employers', 'iwjob'),
            'add_new_item' 			=> __('Add New Employer', 'iwjob'),
            'edit_item' 			=> __('Edit Employer', 'iwjob'),
            'new_item' 				=> __('New Employer', 'iwjob'),
            'view_item' 			=> __('View Employer', 'iwjob'),
            'search_items' 			=> __('Search Employer', 'iwjob'),
            'not_found' 			=> __('Not found', 'iwjob'),
            'not_found_in_trash' 	=> __('Not found in trash', 'iwjob'),
            'parent_item_colon' 	=> '',
        );
        ...
        //Resigter Candidate
        $labels = array(
            'name' 					=> __('Candidates', 'iwjob'),
            'singular_name' 		=> __('Candidate', 'iwjob'),
            'add_new' 				=> __('Add New', 'iwjob'),
            'all_items' 			=> __('Candidates', 'iwjob'),
            'add_new_item' 			=> __('Add New Candidate', 'iwjob'),
            'edit_item' 			=> __('Edit Candidate', 'iwjob'),
            'new_item' 				=> __('New Candidate', 'iwjob'),
            'view_item' 			=> __('View Candidate', 'iwjob'),
            'search_items' 			=> __('Search Candidate', 'iwjob'),
            'not_found' 			=> __('Not found', 'iwjob'),
            'not_found_in_trash' 	=> __('Not found in trash', 'iwjob'),
            'parent_item_colon' 	=> '',
        );
        ...
        //Candidate package
	    $labels = array(
		    'name' 					=> __('Apply Job Packages', 'iwjob'),
		    'singular_name' 		=> __('Apply Job Package', 'iwjob'),
		    'add_new' 				=> __('Add New', 'iwjob'),
		    'all_items' 			=> __('Apply Job Packages', 'iwjob'),
		    'add_new_item' 			=> __('Add New Apply Job Package', 'iwjob'),
		    'edit_item' 			=> __('Edit Apply Job Package', 'iwjob'),
		    'new_item' 				=> __('New Apply Job Package', 'iwjob'),
		    'view_item' 			=> __('View Apply Job Package', 'iwjob'),
		    'search_items' 			=> __('Search Apply Job Package', 'iwjob'),
		    'not_found' 			=> __('Not found', 'iwjob'),
		    'not_found_in_trash' 	=> __('Not found in trash', 'iwjob'),
		    'parent_item_colon' 	=> '',
	    );
        ...
        //Register Cat
        $labels = array(
            'name' 					=> __('Categories', 'iwjob'),
            'popular_items' 		=> __('Popular Categories', 'iwjob'),
            'singular_name' 		=> __('Category', 'iwjob'),
            'add_new' 				=> __('Add New', 'iwjob'),
            'all_items' 			=> __('Categories', 'iwjob'),
    ...
    static function register_post_status(){
        $order_statuses = apply_filters( 'iwj_register_order_post_statuses',
            array(
                ...
                'iwj-cancelled'    => array(
                    'label'                     => _x( 'Cancelled', 'Order status', 'iwjob' ),
                    'public'                    => false,
                    'exclude_from_search'       => true,
                    'show_in_admin_all_list'    => true,
                    'show_in_admin_status_list' => true,
                    'label_count'               => _n_noop( 'Cancelled <span class="count">(%s)</span>', 'Cancelled <span class="count">(%s)</span>', 'iwjob' )
                ),
            )
        );
