        ...
        ob_start();
            ...
            <div id="<?php echo $field['id']; ?>" class="iwj-avatar-container">
                ...
                <div class="desc-change-image">
                    <p class="avatar-description"><?php echo __('Update your photo manually If the photo is not set the default Gravatar will be the same as your login email account', 'iwjob'); ?></p>
