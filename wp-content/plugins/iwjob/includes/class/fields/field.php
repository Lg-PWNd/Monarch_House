...
abstract class IWJMB_Field {
	...
	static function enqueue_scripts(){
        wp_enqueue_style( 'iwjob', IWJ_FIELD_ASSETS_URL . 'css/style.css', array() );
        wp_enqueue_script( 'iwjmb-clone', IWJ_FIELD_ASSETS_URL . 'js/clone.js', array('jquery', 'jquery-ui-sortable'), '', true);
    }
