...
class IWJ_Social_Login_Facebook extends IWJ_Social_Login {
    ...
    public function get_login_url(){
        if(!class_exists('Facebook')) {
            require_once IWJ_PLUGIN_DIR . '/includes/class/socials/Facebook/autoload.php';
        }
    ...
    public function oauth(){
        ...
        if ( isset($access_token) && $access_token && !$access_token->isExpired() )
        {
            ...
            if($user && !is_wp_error($user)){
                ...
                $profile = add_query_arg(array('iwj_tab' => 'profile', 'action' => 'edit'), iwj_get_page_permalink('dashboard'));
