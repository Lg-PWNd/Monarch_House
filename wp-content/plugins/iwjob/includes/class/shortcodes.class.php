...
class IWJ_Shortcodes
{
    ...
    static function jobs($atts) {
        ...
        iwj_get_template_part('parts/jobs', array('query' => $query, 'id_uniqid' => $id_uniqid));
    ...
    static function candidates($atts) {
        ...
        iwj_get_template_part('parts/candidates', array('query' => $query, 'class' => $class));
        $html = ob_get_contents();
        ob_end_clean();
        return $html;
    }
    ...
    static function recent_resumes($atts) {
        ...
        iwj_get_template_part('parts/recent-resumes', array('recent_resumes' => $recent_resumes, 'class' => $class));
        $html = ob_get_contents();
        ob_end_clean();
        return $html;
    }
    ...
    static function employers($atts) {
        ...
        iwj_get_template_part('parts/employers', array('query' => $query, 'class' => $class));
        $html = ob_get_contents();
        ob_end_clean();
        return $html;
    }
    ...
    static function employers_slider($atts) {
        ...
        $employers = iwj_get_employers($employer_ids, $exclude_ids, $hide_empty, $limit, $order_by, $order);
    ...
    static function categories($atts) {
        ...
        iwj_get_template_part('parts/categories', array('categories' => $categories, 'atts' => $atts));
        $html = ob_get_contents();
        ob_end_clean();
        return $html;
    }
    ...
    static function pricing_tables($atts)
    {
        ...
        $_packages = IWJ_Package::get_packages();
        $packages = array();
        if($_packages){
    ...
    static function advanced_search_with_radius($atts)
    {
        ...
        wp_localize_script( 'iwj-search-advanced', 'iwj_search_advanced', array(
            'show_advance_text' => __('Show advance search', 'iwjob'),
            'hide_advance_text' => __('Hide advance search', 'iwjob'),
        ));
        ...
        $html = '';
        ob_start();
        iwj_get_template_part('parts/advanced_search_radius', array('atts' => $atts));
        $html = ob_get_contents();
        ob_clean();
    ...
    static function advanced_search($atts)
    {
        ...
        $html = '';
        ob_start();
        iwj_get_template_part('parts/advanced_search', array('atts' => $atts));
        $html = ob_get_contents();
        ob_clean();
