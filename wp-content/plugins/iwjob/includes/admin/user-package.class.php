        ...
        if($screen->post_type == 'iwj_u_package'){
            ...
            if ($column == 'info') {
                ...
                if($user_package){
                    ...
                    if($type == 'job_package'){
                        echo sprintf(__('Jobs Remaining: <strong>%d</strong>, Features Remaining: <strong>%d</strong>, Renews Remaining: <strong>%d</strong>', 'iwjob'), $user_package->get_remain_job(), $user_package->get_remain_featured_job(), $user_package->get_remain_renew_job());
