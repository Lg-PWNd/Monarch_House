...
class IWJ_Admin_Employer{
    ...
    static function register_metabox(){
        ...
        add_meta_box('iwj-employer-box', __('Employer Info', 'iwjob'), array( __CLASS__, 'metabox_html'), 'iwj_employer', 'normal', 'high');
    }
