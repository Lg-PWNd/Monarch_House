	...
	static function general_import_field( $def ) {
		...
		$settings = array(
			'general' => array(
				...
				'options' => array(
					array(
						'name'    => __( 'Indeed Job Import', 'iwjob' ),
						'options' => array(
							array(
							...
							array(
								...
								'desc'     => __( 'Choose one in list job type is allowed by Indeed.', 'iwjob' ),
							),
							array(
							...
							array(
								...
								'type'  => 'number',
								'std'   => '10',
								'desc'  => __( 'Maximum value is 25, we recommend that you set the Max Item Import parameter to 10.', 'iwjob' ),
							...
							array(
								...
								'type'        => 'user_ajax',
								'placeholder' => __( 'Select an Employer', 'iwjob' ),
								'required'    => true
							),
						)
					),
