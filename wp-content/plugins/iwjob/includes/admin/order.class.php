            ...
            <div class="iwj-metabox wp-clearfix">
                <table class="form-table">
                    ...
                    <?php if($type == '1' || $type == '4'){
                        ?>
                        <tr>
                            <th><label><?php echo __('Package', 'iwjob'); ?></label></th>
                            <td>
                                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="button iwj-send-cusomer-invoice" data-order-id="<?php echo $post->ID; ?>" data-sending-text="<?php echo __('Sending...', 'iwjob')?>"><?php echo __('Send Customer Invoice', 'iwjob'); ?></button>
                        </td>
                    </tr>
                </table>
            </div>
