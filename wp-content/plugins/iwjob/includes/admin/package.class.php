...
class IWJ_Admin_Package{
    ...
    static function init(){
        self::$fields = array(
            ...
            'number_job' => array(
                'name' => __( 'No of Jobs in Package', 'iwjob' ),
            ...
            'number_renew_job' => array(
                'name' => __( 'No of Renew Jobs in Package', 'iwjob' ),
            ...
            'number_featured_job' => array(
                'name' => __( 'No of Featured Jobs in Package', 'iwjob' ),
    ...
    static function columns_head( $columns )
    {
        ...
        if ($screen->post_type == 'iwj_package') {
            $columns = array(
                ...
                'job' => __('Jobs', 'iwjob'),
                'renew_job' => __('Renew Jobs', 'iwjob'),
                'featured_job' => __('Featured Jobs', 'iwjob'),
    ...
    static function columns_content( $column, $post_ID ) {
        ...
        if($screen->post_type == 'iwj_package'){
            ...
            if ($column == 'renew_job') {
                $package = IWJ_Package::get_package($post_ID);
                echo $package->get_number_renew_job();
            }
            if ($column == 'featured_job') {
                $package = IWJ_Package::get_package($post_ID);
                echo $package->get_number_featured_job();
            }
            if ($column == 'duration') {
                $package = IWJ_Package::get_package($post_ID);
