        ...
        function open_info(marker, result){
            google.maps.event.addListener( marker, 'click',( function( marker ) {
                ...
                if(result.user_login === '1'){
                    content += '<a href="#" class="iwj-save-job '+result.savejobclass+'" data-id="'+result.ID+'" data-in-list="true"><i class="fa fa-heart"></i></a></div>';
                }else{
                    content += '<button class="save-job" data-toggle="modal" data-target="#iwj-login-popup"><i class="fa fa-heart"></i></button>';
                }
                content += '</div>';
