...
class Inwave_Shortcode_Class {
    ...
    function __construct() {
        ...
        require_once(INWAVE_COMMON . 'shortcodes/vc_autocomplete.php');
    ...
    function load_shortcode_settings() {
        ...
        if (isset(Inwave_Shortcode::$shortcodes[$shortcode])) {
            ...
            echo __('Not exists', 'inwave-common');
        }
        exit;
    }
    ...
    function enqueue_scripts() {
        ...
        wp_enqueue_script('iw-shortcodes', plugins_url() . '/inwave-common/assets/js/iw-shortcodes.js', array('jquery'), $theme_info->get('Version'), true);
        wp_localize_script( 'iw-shortcodes', 'ajax_posts', array(
            'ajaxurl' => admin_url( 'admin-ajax.php' ),
            'noposts' => __('No older posts found', 'inmusic'), ));
//        wp_enqueue_script('plg-intravel', plugins_url() . '/inwave-common/assets/js/iw-shortcodes.js', array('jquery', 'jquery-ui-core', 'jquery-ui-datepicker'), $theme_info->get('Version'), true);
    ...
    function enqueue_scripts_admin() {
        ...
        wp_enqueue_style('jquery-fancybox', get_template_directory_uri() . '/assets/fancybox/jquery.fancybox.css', array(), $theme_info->get('Version'));
        ...
        wp_enqueue_script('jquery-fancybox', get_template_directory_uri() . '/assets/fancybox/jquery.fancybox.js', array(), $theme_info->get('Version'), false);
        wp_enqueue_script('iw-common', plugins_url() . '/inwave-common/assets/js/iw-admin.js', array('jquery'), $theme_info->get('Version'), true);
        wp_localize_script('iw-common', 'iwConfig', array('ajaxUrl' => admin_url('admin-ajax.php'), 'siteUrl' => site_url(), 'homeUrl' => home_url('/')));
    ...
    function shortcode_add_button() {
        echo '<a href="javascript:void(0);" id="insert-iw-shortcode" class="button">' . __('Insert IW Shortcode', 'inwave-common') . '</a>';
        ?>
        <div id='iw-list-shortcode' class="iw-shortcode list-shortcode iw-hidden">
            <div class="shortcode-contain">
                <div class="shortcode-control">
                    <div class="title"><?php _e('List Shortcode', 'inwave-common'); ?></div>
                    <div class="close-btn"><i class="fa fa-times"></i></div>
                    <div class="filter-box"><input placeholder="<?php echo __('Shortcode filter', 'inwave-common'); ?>" class="shortcode-filter" name="shortcode-filter"/></div>
        ...
        <div id="iw-shortcode" class="iw-hidden iw-shortcode shortcode-item-view">
            <div class="shortcode-contain">
                <div class="shortcode-control">
                    <div class="title"><?php _e('Shortcode settings', 'inwave-common'); ?></div>
                    <div class="close-btn"><i class="fa fa-times"></i></div>
                    <div style="clear: both;"></div>
                </div>
                ...
                <div class="shortcode-save-setting">
                    <div class="save-settings"><?php _e('Insert Shortcode', 'inwave-common'); ?></div>
                    <div class="cancel-settings"><?php _e('Cancel', 'inwave-common'); ?></div>
                    <div class="preview-settings"><?php _e('Preview', 'inwave-common'); ?></div>
    ...
    function get_icon_field($fname, $fvalue, $class) {
        ...
        <div class="control-icon">
            ...
            <div class="icon-filter">
                <input class="filter-input" style="width:49%" onclick="jQuery('.iw-list-icon-wrap').slideDown();" placeholder="<?php echo __('Click to select new or search...', 'inwave-common'); ?>" type="text"/>
	...
	function get_profile_info_field($fname, $fvalue, $class) {
        ...
        <div class="profile_info">
			...
			<button class="addmore"><?php _e("Add more user's skill", 'inwave-common'); ?></button>
	...
	function get_iwe_event_field($fname, $fvalue, $class) {
        ...
        ?>
            <select name="<?php echo $fname;?>" class="iw-field <?php echo $class;?>">
                <option value=""><?php echo __('Select Event', 'inwave-common');?></option>
                <?php
