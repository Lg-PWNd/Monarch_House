        ...
        function init_params() {
            return array(
                ...
                'params' => array(
					...
					array(
                        'type' => 'textfield',
                        "heading" => __("Video URL", 'inwave-common'),
                        "value" => "",
				...
				case 'style1':
					...
					if ($video_url) {
                        ...
                        if($video_poster){
							...
							if ($open_popup){
								$output .= '<button type="button" class="open-popup-btn open-popup bt-video-effect" data-toggle="modal" data-target="#'.$id_modal_target.'"><i class="iwj-icon-play"></i></button>';
							} else {
								$output .= '<div class="play-button bt-video-effect"><i class="iwj-icon-play"></i></div>';
							}
							$output .=	'</div>';
                        }
                    //    $output .= '';
